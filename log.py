...
class MyLog(sg.Window):
    ...
    def __init__(self):
        ...
        self.output = sg.MLine('', p=(5, 0), font=log_font, s=(80, 40), auto_refresh=True, autoscroll=True, disabled=True, expand_x=True, expand_y=True)
        ...
        layout = [[output_col, sg.Col([[self.link_button], [sg.Sizegrip()]], p=0, expand_x=True, expand_y=True)]]
